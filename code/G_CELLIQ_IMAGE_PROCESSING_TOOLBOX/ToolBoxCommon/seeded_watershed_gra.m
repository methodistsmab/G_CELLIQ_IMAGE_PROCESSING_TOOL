function LabMat = seeded_watershed_gra( seeds, img)
...
Marker = bg_marker | sed2;
Marker(Boundary == 1) = 0;

Overlaid_img2 = imimposemin( com_img, Marker);
LabMatPre3 = watershed( Overlaid_img2);
...
LabMat = bwlabel( LabMatPre2);
% 
% ImgMax = ordfilt2( LabMat, 9, ones(3,3), 'symmetric');
% ImgMin = ordfilt2( LabMat, 1, ones(3,3), 'symmetric');
% LabMat = ordfilt2( LabMat, 1, ones(3,3), 'symmetric');
